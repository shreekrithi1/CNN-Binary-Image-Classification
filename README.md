...
```
Optional (for deep learning extensions):
```bash
...
│
├── basic-nlp-on-disaster-tweets.ipynb   # Main notebook
...
## 🧠 Key Findings
- Preprocessing (URL removal, lemmatization) significantly improves accuracy.  
- **TF-IDF + Logistic Regression** offers a strong, interpretable baseline.  
- Removing duplicates and noisy samples stabilizes results.
